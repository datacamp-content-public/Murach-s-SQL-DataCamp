...
- [ ] Add the datasets (preferably as CSV files) for your course in the Teach Editor. Make sure that quotes used in your CSV file are not fancy quotes. Also include the `.sql` file to specify creation of your tables. Check with your CL if any clarity is needed.
...
- [ ] Upload your .sql files for your course on the Teach Editor.
...
- [ ] Sample/Solution code: Less than or equal to 15 lines of code whenever possible. We can be a little flexible here with SQL code, but there should be no more than 25 lines of code.
...
- [ ] Is the sample code appropriately scaffolded? SQL courses use 3 underscores.
